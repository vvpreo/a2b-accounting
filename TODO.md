...
- [ ] Пусть приложение стартует с окна, которое занимает всю рабочую поверхность но не полноэкранный режим. Если пользователь ресайзит - то это сохранятеся в БД и потом восстанавливается при повторном запуске.![1777528066736](image/TODO/1777528066736.png)![1777528071838](image/TODO/1777528071838.png)
